...
int Pthread_create(pthread_t *thread, const pthread_attr_t *attribute, void *(*function)(void*), void *arg)
{
  int rc;

  if ((rc = pthread_create(thread, attribute, function, arg)) != 0)
...
int Pthread_mutex_init(pthread_mutex_t *mutex, const pthread_mutexattr_t *attribute)
{
  ...
  if ((rc = pthread_mutex_init(mutex, attribute)) != 0)
    unix_error("Pthread_mutex_init error");

  return rc;
}

int Pthread_cond_init(pthread_cond_t *cond_var, const pthread_condattr_t *attribute)
{
  int rc;

  if ((rc = pthread_cond_init(cond_var, attribute)) != 0)
    unix_error("Pthread_mutex_init error");
...
int Pthread_cond_wait(pthread_cond_t *cond_var, pthread_mutex_t *mutex)
{
  ...
  if ((rc = pthread_cond_wait(cond_var, mutex)) != 0)
...
int Pthread_cond_signal(pthread_cond_t *cond_var)
{
  ...
  if ((rc = pthread_cond_signal(cond_var)) != 0)
